...
import (
	...
	"github.com/feiskyer/mcs/azureclients/armclient"
...
func New(config *retry.ClientConfig) *Client {
	...
	rateLimiterReader, rateLimiterWriter := retry.NewRateLimiter(config.RateLimitConfig)
